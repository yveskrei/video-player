...
The folder represents a backend server responsible for managing and serving video streams in real time. Using FFmpeg, the server allows users to upload an offline video file, and broadcast it as video stream - outputting MPEG-DASH and fMP4 video.<br>
This allows mimicking a production environment as close as possible, while being able to adjust/change streams quickly
...
## Overview
![Frontend Consumer](../assets/backend-routes.png)
