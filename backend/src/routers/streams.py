"""/streams routes. Sync def on purpose — StreamManager uses a blocking threading.Lock,
so FastAPI runs these in the threadpool."""
from fastapi import APIRouter
from fastapi.responses import Response

# Custom modules
from utils.models import StreamConfig
